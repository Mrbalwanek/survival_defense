...
public class UpgradeManager {
    ...
    public void applyUpgrade(RandomUpgrade u, ArrayList<Character> characters, ArrayList<Enemy> enemies, Beacon beacon, MyPanel panel){
    ...
    public void randomizedUpgrades() {
        ...
        for (int i = 0; i < 3; i++) { //losowanie 3 ulepszeń

            int index = (int)(Math.random() * pool.size());
            UpgradeType selected = pool.get(index);
            pool.remove(index);
